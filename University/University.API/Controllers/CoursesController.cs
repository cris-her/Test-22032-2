...
namespace University.API.Controllers
{
    ...
    public class CoursesController : ApiController
    {
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Post(List<CourseDTO> courseDTO)
        {
            ...
            try
            {
                //var course = mapper.Map<List<Course>>(courseDTO);
                List<Course> course = mapper.Map<List<CourseDTO>, List<Course>>(courseDTO);
